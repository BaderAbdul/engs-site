    ...
    <div className="max-w-7xl mx-auto px-4 py-16">
      <section className="text-center mb-20">
        <h1 className="text-5xl font-extrabold mb-6 text-slate-900 leading-tight">
          مرحباً بك في مجتمع الروبوتات <br/>
          <span className="text-blue-600">GDG_QU</span>
        </h1>
        <p className="text-xl text-slate-600 max-w-2xl mx-auto mb-10">
          منصتك الشاملة لتعلم الهندسة، استعارة القطع، وتتبع فعاليات النادي.
        </p>
        <div className="flex justify-center gap-4">
          <Link href="/events" className="bg-slate-900 text-white px-8 py-4 rounded-full flex items-center gap-2 font-bold hover:bg-slate-800 transition shadow-lg hover:shadow-xl">
            تصفح الفعاليات <ArrowRight size={20} />
          </Link>
        </div>
      </section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
        <div className="p-8 bg-white rounded-3xl shadow-sm border border-slate-100 hover:border-blue-100 transition">
          ...
          <h3 className="text-xl font-bold mb-3">نظام النقاط</h3>
          <p className="text-slate-500 leading-relaxed">احصل على نقاط مقابل كل ورشة تحضرها أو مشروع تشارك به وتميز بين زملائك.</p>
        </div>
        ...
        <div className="p-8 bg-white rounded-3xl shadow-sm border border-slate-100 hover:border-blue-100 transition">
          ...
          <h3 className="text-xl font-bold mb-3">مستودع القطع</h3>
          <p className="text-slate-500 leading-relaxed">تصفح القطع الإلكترونية المتوفرة واطلب استعارتها لمشاريعك بضغطة زر.</p>
        </div>
        ...
        <div className="p-8 bg-white rounded-3xl shadow-sm border border-slate-100 hover:border-blue-100 transition">
          ...
          <p className="text-slate-500 leading-relaxed">تواصل مع زملائك الخبراء للحصول على مساعدة تقنية سريعة في البرمجة والدوائر.</p>
        </div>
      </div>
    </div>
  );
